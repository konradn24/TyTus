...
module.exports.run = async (bot, message, args, database) => {
    ...
    database.query(`SELECT * FROM config WHERE id = 3`, (errC, rowsC) => {
        ...
        if(rowsC[0].value === "false") return response(message, ":x: Nie możesz zobaczyć swojego poziomu, ponieważ poziomy za aktywność są wyłączone.");
